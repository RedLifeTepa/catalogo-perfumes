...
$("#nav").onclick=e=>{const b=e.target.closest("[data-module]");if(!b)return;$$(".nav button").forEach(x=>x.classList.remove("active"));b.classList.add("active");$$(".module").forEach(x=>x.classList.remove("active"));const target=$("#"+b.dataset.module);if(target)target.classList.add("active");$("#sidebar").classList.remove("open")};
...
if($("#docSaleBtn"))$("#docSaleBtn").onclick=generateSaleDoc;if($("#docOrderBtn"))$("#docOrderBtn").onclick=generateOrderDoc;if($("#docClientBtn"))$("#docClientBtn").onclick=generateClientDoc;if($("#docProductBtn"))$("#docProductBtn").onclick=generateKardexDoc;
